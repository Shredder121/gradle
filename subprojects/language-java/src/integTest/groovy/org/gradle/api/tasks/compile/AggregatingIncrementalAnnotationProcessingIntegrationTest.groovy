...
class AggregatingIncrementalAnnotationProcessingIntegrationTest extends AbstractIntegrationSpec {
    ...
    def setup() {
        ...
        fixture.type = IncrementalAnnotationProcessorType.AGGREGATING
    ...
    def "the user is informed about non-incremental processors"() {
        ...
        output.contains("Processor (type: AGGREGATING)")
    }
}
